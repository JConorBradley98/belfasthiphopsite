            ...
            <div class="row"> 
                <div class="colm12">
                    <div class="content-bordering">
                        <form>
                            <fieldset>
                                <legend>Post Content To Index Page: Post 1</legend>
            ...
            <div class="row"> 
                <div class="colm12">
                    <div class="content-bordering">
                        <form>
                            <fieldset>
                                <legend>Post Content To Index Page: Post 2</legend>
            ...
            <div class="row"> 
                <div class="colm12">
                    <div class="content-bordering">
                        <form>
                            <fieldset>
                                <legend>Post Content To Index : Post 3</legend>
            ...
            <div class="row"> 
                <div class="colm12">
                    <div class="content-bordering">
                        <form>
                            <fieldset>
                                <legend>Post Content To Index Page: Post 4</legend>
