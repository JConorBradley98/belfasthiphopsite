    ...
    <body>
        ...
        <div class ="container"> 
            ...
            <ul class="topnav" id="myTopnav2">
                ...
                <li><a href="http://jbradley46.hosting.eeecs.qub.ac.uk/httpdocs/CSC2043WebApplication1/AdminSite/EditContactUs.php" class="active">Edit Contact Us</a></li>
            ...
            <div class="row"> 
                <div class="colm12">
                    <div class="content-bordering">
                        <form>
                            <fieldset>
                                <legend>Post Content To Contact Us Page: Post 1</legend>
                                <label for="Post Title">Content Box 1</label>
                                <div class="row">
                                    <div class="col m6">
            ...
            <div class="row"> 
                <div class="colm12">
                    <div class="content-bordering">
                        <form>
                            <fieldset>
                                <legend>Post Content To Contact us: Post 2</legend>
            ...
            <div class="row"> 
                <div class="colm12">
                    <div class="content-bordering">
                        <form>
                            <fieldset>
                                <legend>Post Content to Contact Us : Post 3</legend>
            ...
            <div class="row"> 
                <div class="colm12">
                    <div class="content-bordering">
                        <form>
                            <fieldset>
                                <legend>Post Content To Contact Us: Post 4</legend>
